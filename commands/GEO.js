...
module.exports = {
	...
	async execute(interaction) {
        ...
        interaction.reply({content: `El superior ${interaction.user}, esta activando el GEO por la siguiente razón: **${reason}**\n\||Ping: <@&810972222494867466>||` ,allowedMentions:{parse:["roles"]}})
